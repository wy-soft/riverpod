...
class ProviderDependenciesRiverpodOnly extends AnalysisRule {
  ProviderDependenciesRiverpodOnly()
    : super(name: code.name, description: code.problemMessage);

  static const code = LintCode(
    'provider_dependencies_riverpod_only',
    '{0}',
...
class ProviderDependenciesRiverpodOnlyFix extends ResolvedCorrectionProducer {
  ProviderDependenciesRiverpodOnlyFix({required super.context});
  ...
  Future<void> compute(ChangeBuilder builder) async {
    ...
    if (newDependencies == null) {
      ...
      await builder.addDartFileEdit(file, (builder) {
        _riverpodRemoveDependencies(builder, riverpodAnnotation);
      });
      return;
    }
